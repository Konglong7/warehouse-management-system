...
-- 3.1 插入用户数据（密码统一为：123456）
INSERT INTO sys_user (username, password, nickname, phone, role) VALUES
('admin', '123456', '系统管理员', '13800138000', 'admin'),
('zhangsan', '123456', '张三', '13800138001', 'user'),
('lisi', '123456', '李四', '13800138002', 'user'),
('wangwu', '123456', '王五', '13800138003', 'user'),
('zhaoliu', '123456', '赵六', '13800138004', 'user');
