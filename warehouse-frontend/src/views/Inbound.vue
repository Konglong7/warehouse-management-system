<template>
  <div>
    <n-button type="primary" @click="handleAdd" style="margin-bottom: 16px">新增入库</n-button>
...
import { NButton, NDataTable, NModal, NForm, NFormItem, NInput, NInputNumber, NSelect, NSpace, useMessage, NTag } from 'naive-ui'
...
const columns = [
  { title: '入库单号', key: 'inboundNo', width: 180 },
  {
    title: '物料',
    key: 'materialId',
    width: 120,
  ...
  { title: '操作人', key: 'operator', width: 100 },
  {
    ...
    key: 'inboundTime',
    width: 160,
    render: (row) => row.inboundTime ? new Date(row.inboundTime).toLocaleString() : '-'
  },
